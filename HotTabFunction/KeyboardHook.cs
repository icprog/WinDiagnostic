...
namespace HotTabFunction
{
    public class KeyboardHook
    {
        ...
        public void SetTestProduct(string Product)
        {
            TestProduct = Product;
        }
        ...
        {
            if (HotTabDLL.IsDebugMode) Trace.WriteLine("KeyboardHook() Start");
            if (hKeyboardHook == 0 && InstallKeyboardHook)
            {
                ...
                if (HotTabDLL.IsDebugMode) Trace.WriteLine("ModuleName : " + Process.GetCurrentProcess().MainModule.ModuleName + ", Handle : " + GetModuleHandle(Process.GetCurrentProcess().MainModule.ModuleName));
                if (hKeyboardHook == 0)
                {
                ...
                else
                {
                    ...
                    if (HotTabDLL.IsDebugMode) Trace.WriteLine("Add KeyUpForHook()");
        ...
        {
            if (HotTabDLL.IsDebugMode) Trace.WriteLine("KeyboardHook() Stop");
